...
@Entity
@Table(name="Daily_Production_RM_Master")
 ...
 * @since 2018.10.09
 */
public class UnitDailyProductionMasterRM implements Serializable, GEntity {
    ...
    public UnitDailyProductionMasterRM(){
        this.sTransNox = "";
        this.dTransact = null;
        this.sRemarksx = "";
        this.nEntryNox = -1;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UnitDailyProductionMasterRM)) {
            return false;
        }
        UnitDailyProductionMasterRM other = (UnitDailyProductionMasterRM) object;
        return !((this.sTransNox == null && other.sTransNox != null) || (this.sTransNox != null && !this.sTransNox.equals(other.sTransNox)));
    }
    
    @Override
    public String toString() {
        return "org.rmj.inventory.production..pojo.UnitDailyProductionMasterRM[sTransNox=" + sTransNox + "]";
    }
    ...
    public String getTable() {
        return "Daily_Production_RM_Master";
    }
